...
public class ShoppingPage implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == checkout) {
			JOptionPane.showMessageDialog(null, "Your order for " + " ShoppingCart.getTotalQuantityOfItems() "  + " items ($ " + "ShoppingCart.getTotal()" + " ) was completed successfully.", "Order Successful", JOptionPane.DEFAULT_OPTION);
		}
